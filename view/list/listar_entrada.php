<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $sql = "SELECT * FROM registros_entrada WHERE MONTH(data_entrada) = $mesSelecionado";
        ...
        $sql = "SELECT * FROM registros_entrada";
        $resultado = mysqli_query($conexao, $sql);
    }
?>
...
<html>
    ...
    <div class="tabela">
        <h1>Lista de Adições no Estoque</h1>
        ...
        <div class="gera1">
            <form class="form_gera_entrada" action="../BD/docs/geraDoc_entrada.php" method="post">
